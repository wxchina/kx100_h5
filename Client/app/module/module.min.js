...
description: 各个模块的方法
*/
define(["public/util.js", "bower_components/echarts/dist/echarts.min"], function(u, echarts) {
    ...
    function terminalactivity() {
        ...
        var option1 = {
            ...
            xAxis: [{
                ...
                data: ["下单>10次", "下单5-10次", "下单<5次", "从未下单"]
            }],
            yAxis: [{
                type: 'value',
                minInterval: 5
    ...
    function salesasync() {
        ...
        var option1 = {
            ...
            xAxis: [{
                ...
                axisLabel: { interval: 0, rotate: 45 },
                splitLine: { show: false },
                data: ["全家便利店", "ok便利店", "家乐福", "百佳", "吉之岛", "华润万家"]
            }],
            yAxis: [{
                type: 'value',
                minInterval: 5
    ...
    function visitasync() {
        ...
        $('.sales-async nav').on('touchend', 'li', function() {
            ...
            if ($(this).index() == 1) {
                $.extend(option1, {
                    xAxis: [{
                        data: [curMonth + "." + 1, curMonth + "." + 5, curMonth + "." + 9, curMonth + "." + 13, curMonth + "." + 17, curMonth + "." + 21, curMonth + "." + 25]
                    }],
                    series: [{
                        name: '本月',
                        type: 'line',
    ...
    function promotionasync() {
        ...
        var option1 = {
            ...
            xAxis: [{
                ...
                axisLabel: { interval: 0, rotate: 45 },
                splitLine: { show: false },
                data: ["中秋促销", "国庆促销", "五一促销", "元旦促销", "双十一促销"]
            }],
            yAxis: [{
                type: 'value',
                minInterval: 5
