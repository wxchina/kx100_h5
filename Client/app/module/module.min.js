...
*/
        ...
        XuntongJSBridge.call('getLocation', {}, function(result) {
            ...
            addLayer("w导入终端100", 50, -10);
            addLayer("w导入终端86", 10, -100);
            //点击事件
            function mapevent() {
                map.addEventListener("click", function(e) {
                    if (e.overlay) {
        ...
        function touch() {
            ...
            switch (event.type) {
                ...
                case "touchmove":
                    ...
                    console.log(beforeClient);
                    beforeClient && (target.style.left = Number(target.style.left.slice(0, -2)) + Number(event.touches[0].clientX - beforeClient) + "px");
