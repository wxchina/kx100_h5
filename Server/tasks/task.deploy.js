...
module.exports = function() {
    ...
    Q.fcall(function() { //第一步：执行publish任务
        ...
        .then(function(file) { //第二步,远程部署服务器Web站点
            var argv = process.argv[3] && process.argv[3] || '',
                ms = {
                    host: '42.159.86.120',
                    port: 61025,
                    username: 'xuanwu',
                    password: 'Xw61302222',
                    deploypath: '/home/xuanwu',
                    description: '微软云部署环境(CentOS6.5)'
                },
                pf = {
                    host: '192.168.8.113',
                    port: 22,
                    username: 'root',
                    password: 'xuanwu61302222',
                    deploypath: '/home/xtionweb',
                    description: '品管性能测试环境(CentOS6.5)'
                },
                develop = {
                    host: '120.132.147.139',
                    port: 22,
                    username: 'xtionweb',
                    password: 'xtionweb@123',
                    deploypath: '/home/xtionweb',
                    description: '开发环境(CentOS5.5)'
                },
                test = {
                    host: '192.168.8.53',
                    port: 22,
                ...
                publish = {
                    ...
                    password: '123456',
                    deploypath: '/home/xtionweb',
                    description: '上线公测环境(CentOS6.5)'
                },
                local = {
                    host: '192.168.32.129',
                    port: 22,
                    username: 'weichangying',
                    password: '18620128143',
                    deploypath: '/home/xtionweb',
                    description: '本地Nginx测试环境（CentOS6.5）'
                },
                testenv = {
                    host: '192.168.8.57',
                    port: 22,
