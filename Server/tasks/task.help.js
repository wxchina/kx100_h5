...
module.exports = function() {
    ...
    process.stdout.write(util.format('\x1b[33m%s', '  node main.js  [help] [test] [perf] [init] [build] [deploy] [publish] [default]\n\n'));
    ...
    process.stdout.write(util.format('\x1b[32m%s', '  node main.js perf:    '));
    process.stdout.write(util.format('\x1b[37m%s', 'run front-end auto performance watch\n\n'));
